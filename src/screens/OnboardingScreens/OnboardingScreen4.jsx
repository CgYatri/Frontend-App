...
const OnboardingIllustration = require('../../assets/images/onboarding-illustration4.png');
...
with quality experience
      ...
      <View className="px-6 pb-8">
        ...
        {/* Get Started Button */}
        <TouchableOpacity onPress={() => navigation.navigate("HomeScreen")} className="bg-blue-600 w-full py-4 rounded-xl items-center justify-center">
